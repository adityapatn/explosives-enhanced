...
public class ModBlocks {
    ...
    public static final Block LandscaperBlock = registerBlock("landscaper_block", new LandscaperBlock(AbstractBlock.Settings.create().sounds(BlockSoundGroup.CROP).strength(1.0f)));
